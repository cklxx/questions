...
export function Button({
    ...
    const baseStyles =
        'relative inline-flex items-center justify-center rounded-xl font-medium transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary/30 focus:ring-offset-[#f6f7fb] disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98] shadow-sm';
